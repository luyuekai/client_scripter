/**
 * this View Model is for kaggle system
 * @return {undefined}
 */
/**
...
function DownloadModel(parent) {
  ...
  var username = UserPOJO.user.userName;
  if (parent.download_type === 'PDF') {
    download_file_href = $.getRootPath() + "/matrix/report/" + username + "/" + filename + ".pdf";
    download_name = parent.name() ? parent.name() : 'Report' + ".pdf";
  } else if (parent.download_type === 'HTML') {
    download_file_href = $.getRootPath() + "/matrix/report/" + username + "/" + filename + ".html";
    download_name = parent.name() ? parent.name() : 'Report' + ".html";
  } else if (parent.download_type === 'MD') {
    download_file_href = $.getRootPath() + "/matrix/report/" + username + "/" + filename + ".md";
