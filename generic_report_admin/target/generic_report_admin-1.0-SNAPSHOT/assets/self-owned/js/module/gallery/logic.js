...
var retrieveData_saved_self = function() { //对应通过审核页面
...
var retrieveData_shared_self = function() { //对应拒绝审核
  var keyword = SearchPOJO.keywords;
  var likeOrMap = {};
  if (keyword) {
    likeOrMap = {
...
var retrieveData_shared_all = function() { //对应待处理审核
  var keyword = SearchPOJO.keywords;
  var likeOrMap = {};
  if (keyword) {
    likeOrMap = {
...
var retrieveData_template_all = function() { //对应已处理报告
  var keyword = SearchPOJO.keywords;
  var likeOrMap = {};
  if (keyword) {
    likeOrMap = {
