...
var QueryChainTestPOJO = {
  ...
  chain_query_test: function() {
    ...
    QueryChainPOJO.queryArray.push({
      'id': 1,
      'query': QueryChainTestPOJO.query1
    });
    QueryChainPOJO.queryArray.push({
      'id': 2,
      'query': QueryChainTestPOJO.query2
    });
    QueryChainPOJO.queryArray.push({
      'id': 3,
      'query': QueryChainTestPOJO.query3
    });
    QueryChainPOJO.queryArray.push({
      'id': 4,
      'query': QueryChainTestPOJO.query4
    });
...
var t = function() {
  ...
  var json_obj = {
    ...
    "eqMap": {
      "type": "MATRIX_GENERIC_SUGGESTION",
      "deleted": false
    }
  };
