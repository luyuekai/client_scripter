...
function successListener() {
    if (arguments && arguments[1]) {
        ...
        setTimeout(function () {
            switch (chart_type) {
                case 'bar':
                    if (typeof barViewModel != "undefined") {
                ...
                case 'line':
                    if (!option.series[0].areaStyle) {
                        ...
                        setTimeout(function () {
                            if (typeof lineViewModel != "undefined") {
                                if (option.xAxis[0].data) {
                        ...
                        setTimeout(function () {
                            if (typeof areaViewModel != "undefined") {
                                if (option.xAxis[0].data) {
                    ...
                    break;
                case 'scatter':
                    if (typeof scatterViewModel != "undefined") {
                        if (option.xAxis[0].data) {
                ...
                case 'radar':
                    ...
                    break;
                case 'treemap':
                    if (typeof treemapViewModel != "undefined") {
                        treemapViewModel.series(JSON.stringify(option.series[0].data));
                    }
                    break;
                case 'heatmap':
                    if (typeof heatmapViewModel != "undefined") {
                    ...
                    break;
                case 'parallel':
                    if (typeof parallelViewModel != "undefined") {
                        var a = '';
                        var b = '';
                ...
                case 'graph':
                    ...
                    if (layout == 'none') {
                        ...
                        setTimeout(function () {
                            if (typeof graphViewModel != "undefined") {
                        ...
                        setTimeout(function () {
                            if (typeof circularViewModel != "undefined") {
                        ...
                        setTimeout(function () {
                            if (typeof forceViewModel != "undefined") {
